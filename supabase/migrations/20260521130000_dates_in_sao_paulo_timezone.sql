...
-- get_attendance_messages_by_hour: 'today' e janelas relativas em SP
...
BEGIN
  ...
  -- Início do dia em America/Sao_Paulo (convertido de volta para timestamptz)
  ...
  _from := CASE _range
    ...
    ELSE              _today_sp - interval '6 days'  -- '7d' inclui hoje
  END;
...
-- get_company_growth: enumera dias do calendário SP
