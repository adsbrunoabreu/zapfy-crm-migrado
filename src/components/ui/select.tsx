...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "disabled:cursor-not-allowed disabled:opacity-60 disabled:bg-muted disabled:hover:border-input",
  ...
  <SelectPrimitive.Portal>
    ...
    >
      ...
      <SelectPrimitive.Viewport
        ...
        onWheel={(e) => {
          // Prevent parent Dialog scroll-lock from swallowing wheel events
          e.stopPropagation();
        }}
      >
        {children}
